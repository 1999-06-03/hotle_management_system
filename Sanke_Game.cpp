...
public:
	...
	void Draw() {
		...
		SetConsoleTextAttribute(hConsole, 14); // Yellow
   		...
   		SetConsoleTextAttribute(hConsole, 0x4B); // black txt, Red Stake
		cout << "92";
		SetConsoleTextAttribute(hConsole, 14); // yellow
		...
		SetConsoleTextAttribute(hConsole, 0x4F); // black txt, Red Stake
		cout << "67";
		SetConsoleTextAttribute(hConsole, 14); // yellow
		...
		SetConsoleTextAttribute(hConsole, 0xCA); // black txt, Red Stake
		cout << "59";
		SetConsoleTextAttribute(hConsole, 14); // yellow
		...
		SetConsoleTextAttribute(hConsole, 0xC0); // black txt, Red Stake
		cout << "41";
		SetConsoleTextAttribute(hConsole, 14); // yellow
		...
		SetConsoleTextAttribute(hConsole, 0xC1); // black txt, Red Stake
		cout << "31";
		SetConsoleTextAttribute(hConsole, 14); // yellow
